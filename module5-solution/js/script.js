...
(function(global) {
    ...
    function buildAndShowHomeHTML(categories) {
        ...
        $ajaxUtils.sendGetRequest(
            homeHtmlUrl,
            function(homeHtml) {
                console.log("trinhlvd x", homeHtml);
    ...
    dc.loadtrinhlvd = function() { console.log("dcm"); };
    ...
    function buildAndShowCategoriesHTML(categories) {
        ...
        console.log("Trinhlvd 1", categories);

        dc.allCategorieslist = categories; //trinhlvd added
